...
use App\Domain\API\Voucher\VoucherWalletRequest as ValidRequest;

/**
 * ListVouchers Voucher
 */

final class GetVoucherWallet
{
    private $logger;
    private $repository;
    private $settings;
    ...
    public function __invoke(Request $request, Response $response, array $args): response
    {
        try {
            ...
            $this->logger->info("Getting voucher with wallet started.");
            
            $return = $this->repository->getVoucherWallet($validRequest);

            $this->logger->info("Getting voucher with wallet complete");
