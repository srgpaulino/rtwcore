...
final class VerifyingPayment {
    ...
    public function __invoke(Request $request, Response $response, array $args): response {
        ...
        try {
            ...
            $this->logger->info("Payment verifying started.");

            $webhookKey = $this->settings['stripe']['webhook_key'];
            $intent = $this->repository->paymentVerify($webhookKey);
...
//            ];
            ...
            $this->logger->info("Payment verify complete");
